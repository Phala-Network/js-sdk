...
import {
  ProposalContents,
  ProposalTitle,
} from "@phala/sdk/interfaces/signaling";
import { TallyType, VoteOutcome, VoteType } from "@phala/sdk/interfaces/voting";
import {
  ApiTypes,
...
import { bool, Bytes, Data, u16, u32, u64 } from "@polkadot/types/primitive";
  ...
  export interface AugmentedSubmittables<ApiType> {
    system: {
      ...
      killStorage: AugmentedSubmittable<
        (
          keys: Vec<Key> | (Key | string | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
    ...
    timestamp: {
      ...
      set: AugmentedSubmittable<
        (
          now: Compact<Moment> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
    };
    authorship: {
    ...
    democracy: {
       ...
       * # </weight>
       **/
      proxyVote: AugmentedSubmittable<
        (
          refIndex: Compact<ReferendumIndex> | AnyNumber | Uint8Array,
          vote:
            | Vote
      ...
      emergencyCancel: AugmentedSubmittable<
        (
          refIndex: ReferendumIndex | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      cancelQueued: AugmentedSubmittable<
        (
          which: ReferendumIndex | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       * # </weight>
       **/
      setProxy: AugmentedSubmittable<
        (
          proxy: AccountId | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
    ...
    finalityTracker: {
      ...
      finalHint: AugmentedSubmittable<
        (
          hint: Compact<BlockNumber> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
    };
    grandpa: {
    ...
    identity: {
      ...
      cancelRequest: AugmentedSubmittable<
        (
          regIndex: RegistrarIndex | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
    ...
    nicks: {
       ...
       * # </weight>
       **/
      forceName: AugmentedSubmittable<
        (
          target:
            | LookupSource
            | Address
    ...
    signaling: {
      ...
      createProposal: AugmentedSubmittable<
        (
          title: ProposalTitle | string | Uint8Array,
          contents: ProposalContents | string | Uint8Array,
          outcomes: Vec<VoteOutcome> | (VoteOutcome | string | Uint8Array)[],
          voteType:
            | VoteType
            | ("Binary" | "MultiOption" | "RankedChoice")
            | number
            | Uint8Array,
          tallyType: TallyType | ("OnePerson" | "OneCoin") | number | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       **/
      advanceProposal: AugmentedSubmittable<
        (
          proposalHash: Hash | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
    ...
    voting: {
      ...
      commit: AugmentedSubmittable<
        (
          voteId: u64 | AnyNumber | Uint8Array,
          commit: VoteOutcome | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       **/
      reveal: AugmentedSubmittable<
        (
          voteId: u64 | AnyNumber | Uint8Array,
          vote: Vec<VoteOutcome> | (VoteOutcome | string | Uint8Array)[],
          secret: Option<VoteOutcome> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
    };
  }
