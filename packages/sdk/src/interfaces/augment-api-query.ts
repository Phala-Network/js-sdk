...
import { ProposalRecord } from "@phala/sdk/interfaces/signaling";
import { VoteRecord } from "@phala/sdk/interfaces/voting";
...
import { bool, Bytes, Data, u32, u64 } from "@polkadot/types/primitive";
...
declare module "@polkadot/api/types/storage" {
  export interface AugmentedQueries<ApiType> {
    system: {
       ...
       **/
      allExtrinsicsWeight: AugmentedQuery<
        ApiType,
    ...
    utility: {
      ...
      multisigs: AugmentedQueryDoubleMap<
        ...
        (
          ...
          key2: U8aFixed | string | Uint8Array
        ) => Observable<Option<Multisig>>
      >;
    };
    timestamp: {
      /**
    ...
    balances: {
      ...
      vesting: AugmentedQuery<
        ...
        ) => Observable<Option<VestingSchedule>>
      >;
      /**
    ...
    staking: {
       ...
       **/
      currentEraPointsEarned: AugmentedQuery<
        ApiType,
        () => Observable<EraPoints>
      >;
      /**
      ...
      slashingSpans: AugmentedQuery<
        ...
        (
          arg: AccountId | string | Uint8Array
        ) => Observable<Option<SlashingSpans>>
      >;
      /**
        ...
        (
          arg:
            ...
            | [
                ...
                SpanIndex | AnyNumber | Uint8Array
              ]
       ...
       **/
      earliestUnappliedSlash: AugmentedQuery<
        ApiType,
    ...
    session: {
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[ValidatorId, Keys]>>>
      >;
      /**
    ...
    democracy: {
      ...
      publicProps: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[PropIndex, Hash, AccountId]>>>
      >;
      /**
      ...
      preimages: AugmentedQuery<
        ...
        (
          ...
          Option<ITuple<[Bytes, AccountId, BalanceOf, BlockNumber]>>
        >
      >;
      /**
      ...
      depositOf: AugmentedQuery<
        ApiType,
        (
          arg: PropIndex | AnyNumber | Uint8Array
        ) => Observable<Option<ITuple<[BalanceOf, Vec<AccountId>]>>>
      >;
      /**
       * The next free referendum index, aka the number of referenda started so far.
       **/
      referendumCount: AugmentedQuery<
        ApiType,
        () => Observable<ReferendumIndex>
      >;
      /**
      ...
      referendumInfoOf: AugmentedQuery<
        ApiType,
        (
          arg: ReferendumIndex | AnyNumber | Uint8Array
        ) => Observable<Option<ReferendumInfo>>
      >;
      /**
       * Queue of successful referenda to be dispatched. Stored ordered by block number.
       **/
      dispatchQueue: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[BlockNumber, Hash, ReferendumIndex]>>>
      >;
      /**
       * Get the voters for the current proposal.
       **/
      votersFor: AugmentedQuery<
        ApiType,
        (
          arg: ReferendumIndex | AnyNumber | Uint8Array
        ) => Observable<Vec<AccountId>>
       ...
       **/
      voteOf: AugmentedQuery<
        ApiType,
        (
          arg:
            | ITuple<[ReferendumIndex, AccountId]>
            | [
                ReferendumIndex | AnyNumber | Uint8Array,
                AccountId | string | Uint8Array
              ]
        ) => Observable<Vote>
      >;
       ...
       **/
      delegations: AugmentedQuery<
        ApiType,
        (
          arg: AccountId | string | Uint8Array
        ) => Observable<ITuple<[AccountId, Conviction]>>
      >;
      /**
      ...
      nextExternal: AugmentedQuery<
        ApiType,
        () => Observable<Option<ITuple<[Hash, VoteThreshold]>>>
      >;
      /**
      ...
      blacklist: AugmentedQuery<
        ...
        (
          arg: Hash | string | Uint8Array
        ) => Observable<Option<ITuple<[BlockNumber, Vec<AccountId>]>>>
      >;
      /**
      ...
      cancellations: AugmentedQuery<
        ApiType,
        (arg: Hash | string | Uint8Array) => Observable<bool>
      >;
    };
    council: {
      /**
      ...
      voting: AugmentedQuery<
        ApiType,
        (arg: Hash | string | Uint8Array) => Observable<Option<Votes>>
      >;
      /**
       * Proposals so far.
       **/
    ...
    elections: {
      ...
      members: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[AccountId, BalanceOf]>>>
      >;
      /**
      ...
      votesOf: AugmentedQuery<
        ApiType,
        (arg: AccountId | string | Uint8Array) => Observable<Vec<AccountId>>
      >;
      /**
    ...
    grandpa: {
      ...
      pendingChange: AugmentedQuery<
        ApiType,
        () => Observable<Option<StoredPendingChange>>
      >;
      /**
       * next block number where we can force a change.
       **/
      nextForced: AugmentedQuery<
        ApiType,
      ...
      setIdSession: AugmentedQuery<
        ApiType,
        (
          arg: SetId | AnyNumber | Uint8Array
    ...
    treasury: {
      ...
      proposals: AugmentedQuery<
        ApiType,
        (
          arg: ProposalIndex | AnyNumber | Uint8Array
        ) => Observable<Option<TreasuryProposal>>
      >;
      /**
    ...
    contracts: {
      ...
      codeStorage: AugmentedQuery<
        ApiType,
        (
          arg: CodeHash | string | Uint8Array
        ) => Observable<Option<PrefabWasmModule>>
      >;
      /**
       * The subtrie counter.
       **/
      ...
      contractInfoOf: AugmentedQuery<
        ...
        (
          arg: AccountId | string | Uint8Array
        ) => Observable<Option<ContractInfo>>
      >;
      /**
    ...
    identity: {
      ...
      superOf: AugmentedQuery<
        ...
        (
          arg: AccountId | string | Uint8Array
        ) => Observable<Option<ITuple<[AccountId, Data]>>>
      >;
      /**
      ...
      subsOf: AugmentedQuery<
        ...
        (
          arg: AccountId | string | Uint8Array
        ) => Observable<ITuple<[BalanceOf, Vec<AccountId>]>>
      >;
      /**
      ...
      registrars: AugmentedQuery<
        ApiType,
        () => Observable<Vec<Option<RegistrarInfo>>>
      >;
    };
    imOnline: {
      /**
    ...
    offences: {
      ...
      reports: AugmentedQuery<
        ApiType,
        (
          arg: ReportIdOf | string | Uint8Array
        ) => Observable<Option<OffenceDetails>>
      >;
      /**
    ...
    nicks: {
       ...
       **/
      nameOf: AugmentedQuery<
        ApiType,
        (
          arg: AccountId | string | Uint8Array
        ) => Observable<Option<ITuple<[Bytes, BalanceOf]>>>
      >;
    };
    sudo: {
      /**
    ...
    signaling: {
       ...
       **/
      inactiveProposals: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[Hash, BlockNumber]>>>
      >;
      /**
       * A list of active proposals along with the time at which they complete.
       **/
      activeProposals: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[Hash, BlockNumber]>>>
      >;
      /**
       ...
       **/
      completedProposals: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[Hash, BlockNumber]>>>
      >;
      /**
      ...
      proposalOf: AugmentedQuery<
        ApiType,
        (arg: Hash | string | Uint8Array) => Observable<Option<ProposalRecord>>
      >;
      /**
       * Registration bond
       **/
      proposalCreationBond: AugmentedQuery<
        ApiType,
    ...
    voting: {
       ...
       **/
      voteRecords: AugmentedQuery<
        ApiType,
        (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<VoteRecord>>
      >;
      /**
